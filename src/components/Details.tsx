...
export default function Details() {
  return (
    <div className='bg-[rgb(150,117,85)] lg:px-[150px] xl:px-[200px] py-16 lg:py-28 text-white flex flex-col-reverse lg:flex-row'>
      ...
      <div className='flex-1 flex items-center justify-center lg:justify-normal'>
        <div className='bg-[rgb(209,193,177)] w-[320px] h-[450px] ml-16 relative'>
          <Image
